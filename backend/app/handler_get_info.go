...
const (
	...
	getReferralFeeQuery = `SELECT id, branch_id, referral_id, parent_id, code, display_code, sharing_fee, is_handle_tax, is_root_referral, assigned_at, created_at FROM referral_fees WHERE is_root_referral = 1 AND is_selectable = 1 ORDER BY display_code ASC;`
)
